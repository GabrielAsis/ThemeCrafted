          ...
          <div className="left-side">
            ...
            <div className="mobile-right-side">
              <div className="details">
                ...
                <h3>$20.00</h3>
                <p>Clean, modern design tailored for creatives and freelancers.</p>
              </div>

              <div className="stats">
                <div className="reviews stat-card">
                  <h3>4.2 <Star className='star' /></h3>
                  <p>15 reviews</p>
                </div>
            ...
            <div className="about section">
              ...
              <p>Minimalist Portfolio is the epitome of elegant simplicity, designed specifically for creatives who want their work to speak volumes without distractions. This theme employs a careful balance of whitespace, typography, and understated transitions that guide visitors' attention directly to your portfolio pieces. With optimized image loading and a responsive grid system, your projects will shine on any device while maintaining exceptional page speed scores.
              <br /><br />
              ...
              <div className="item-container">
                <div className="item">
                  ...
                  <div className="review">
                    <p>I've tried dozens of themes over the years, but Awesome Theme is by far the easiest and fastest to work with. My site looks professional, loads incredibly fast, and I didn't need to touch a single minor ...More</p>
                  </div>
                </div>
              </div>
            </div>
