                ...
                >
                  ...
                  {testimonials.map((item) => (
                    <SwiperSlide key={item.id}>
                      <img src={item.img} alt={`Screenshot of ${item.themTitle}`} />
                    </SwiperSlide>
                  ))}
                </Swiper>
              </div>
            </div>
            <div class="monitor-base-top"></div>
            <div class="monitor-base-bottom"></div>
          </div>
          <div className="theme-details">
            ...
            >
              ...
              {testimonials.map((item) => (
                <SwiperSlide key={item.id}>
                  <p>
                    <Link className="link">{item.themTitle}</Link> • <span className='price'>${item.themePrice}</span>
                  </p>
                </SwiperSlide>
              ))}
            </Swiper>
        ...
        <div className="right-side">
          <Swiper
            ...
            onSwiper={(swiper) => {
              ...
              if (monitorSwiperRef.current && themeSwiperRef.current) {
                swiper.controller.control = [monitorSwiperRef.current, themeSwiperRef.current];
          ...
          >
            ...
            <div className="swiper-nav">
              <button className="swiper-prev-btn primary-btn"><ArrowLeft /></button>
              <button className="swiper-next-btn primary-btn"><ArrowRight /></button>
            </div>
        </div>
      </div>
    </div>
